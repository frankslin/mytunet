  ...
  <TR>
    <TD class=sidebar vAlign=top width=133 height=400><BR>
      <TABLE cellSpacing=2 cellPadding=2 width=118 align=center border=0>
        <TR>
          <TD><span class="style3">最新版本2005.12.31</span></TD>
        </TR>
        <TR>
        ...
        <TR>
          <TD><A href="#download">下载与安装</A><br>
            ><a href="/down/mytunet-lite.zip" class="emphlink">简洁版</a> <a href="/down/mytunet-full.zip" class="emphlink">完整版</a></TD>
        </TR>
        <TR>
	...
	<TR>
          <td><?PHP echo "Total Visitors: $count"; ?>
<!-- phpmyvisites -->
...
var phpmyvisitesURL = "http://www.mytunet.com/phpmv2/phpmyvisites.php";
//-->
</script>
<script language=javascript src="http://www.mytunet.com/phpmv2/phpmyvisites.js" type="text/javascript"></script>
<noscript>
<p>phpMyVisites : 一个用PHP/MySQL技术开发，采用Gnu GPL.方式发布的关于网站访问量统计的开源软件
<img src="http://www.mytunet.com/phpmv2/phpmyvisites.php" alt="phpMyVisites" style="border:0" />
</p>
</noscript>
<!-- /phpmyvisites --> 
          </td>
    ...
    <TD vAlign=top width=851>
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align="center" border="0">
        <tr><td>&nbsp;</td></tr>
		<TR>
          <TD bgcolor="#CC9900"><p>据悉，学校在一段时间之后将启用新的校园网登录系统，并采用新的认证协议。届时，当前的 MyTunet 将不再适用。如果我们有精力且认为有意义开发新版本 MyTunet，我们可能还会继续对它进行更新。否则，我们将不再提供 MyTunet 的更新。</p>
      ...
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align=center border=0>
        ...
        <TR>
          <TD>
            <H4><STRONG>什么是 MyTunet？</STRONG></H4></TD></TR>
        <TR>
          <TD height="84">
            <P>MyTunet 是一个能方便你使用清华大学校园网的工具。有了 MyTunet，登录校园网、切换登录账号等任务将变得非常轻松。你不再需要先注销，改登录类型，输入新的用户名，输入新的密码——MyTunet 将自动为你的完成这些繁琐的步骤。如果你是一名住在紫荆公寓的本科生，并且使用着台式电脑，那么你更可以启用“熄灯提醒”功能。开启此项功能后，每到熄灯前 5 分钟，会弹出一个对话框提示你关机。</P></TD></TR></TBODY></TABLE>
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align=center border=0>
        <TBODY>
        <TR>
          <TD>
            <H4><STRONG>MyTunet 的特点</STRONG></H4></TD></TR>
        <TR>
          <TD height="148"><UL><LI>官方 TUNet 所具有的基本功能（如登录网络等）                            
              <LI>                中/英文双语言界面              
              <LI>自动安装驱动程序              （特色功能）
      ...
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align=center border=0>
        ...
        <TR>
          <TD>
            <H4><STRONG>MyTunet / qtunet 界面截图</STRONG></H4></TD></TR>
        <TR>
      ...
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align=center border=0>
        ...
        <TR>
          <TD><P><SPAN class=download-title><a href="/down/mytunet-lite.zip">MyTunet for Windows 简洁版</a></SPAN> [2005年12月31日] [944 KB] </P>
              <P><SPAN class=download-title><a href="/down/mytunet-full.zip">MyTunet for Windows 完整版</a></SPAN> [2005年12月31日] [1.14 MB]<BR>
                完整版是在简洁版的基础上，增加了“IP地址切换”和“Windows 802.1x 认证计算器”两个小工具后，重新打包而成的。 </P>
            <P><SPAN class=download-title><a href="/down/mytunet">MyTunet for Linux</a> </SPAN> [2005年12月09日] [795 KB] <span class="style3">请先<a href="linux.html" target="_blank">阅读说明</a></span></P>
            <P><SPAN class=download-title><a href="/down/qtunet">qtunet for Linux 图形界面</a></SPAN> [2005年12月09日] [0.99 MB] <span class="style3">请先<a href="linux.html" target="_blank">阅读说明</a></span></P></TD>
        </TR>
        <TR>
          <TD>
...
请及时将错误的具体情况<a href="#contact">反馈给我们</a>。或者，您可以简单地从 http://www.mytunet.com 下载一份 WinPCap for AMD64 的<a href="#drivers">驱动程序</a>。</P>
            </TD>
        </TR>
        <tr>
        ...
        <tr>
          <td><p>首先解释一下什么是服务（如果您很熟悉，请跳过这一段）：服务程序是一种特殊的 Windows 程序，它可以在系统刚启动的时候就被运行。也就是说，哪怕用户还没   登录Windows，只要开机，服务程序就会自动运行。这种程序一般用于提供网络服务等，所以就叫“服务（Service）”了。</p>
              <p>MyTunet 目前支持安装为一个服务，其服务程序是 MyTunetSvc.exe，安装成功后服务名是“   MyTunetSvc”。
                当然，您并不需要知道它到底是如何工作的，在 MyTunet 的主界面中，您可以轻松完成对 MyTunet 服务的各种操作。 </p>
            <p>先说明一个基本问题： MyTunet 的普通应用模式和服务模式是不能同时启用的。也就是说，如果你安装了 MyTunetSvc 服务，那么 MyTunet 的所有操作都会依靠服务来进行，而不再是在主程序里进行操作了。</p>
            <p>并且，安装 MyTunetSvc 服务后，与普通模式会有以下不同：</p>
            <ul>
              <li>开机后就自动连网，而不是登录 Windows 运行 MyTunet   程序后才连网。
              <li> 不再支持“最低余额警告保护”功能。              
              <li> 对登录认证的各种重试操作都不再依靠用户设置，而由服务自己决定。              
              <li> MyTunet   主程序只起到“控制器”的作用，即只负责控制服务的运行，而不再亲自过问连网事宜。<br>
            ...
            <p><strong>说明：除非您确实需要服务所提供的这些功能，强烈建议您不要采取服务模式来连网！</strong></p></td>
        </tr>
      </table>
      ...
      <TABLE cellSpacing=2 cellPadding=2 width="90%" align=center border=0>
        <TBODY>
        <TR>
          <TD><p>如果您发现了软件的 bug，或还有其他不明白的事项，都可以联系我们的技术支持人员，我们将尽最大努力为你解释清楚。如果您对本软件有什么建议或新奇的想法，也请告诉我们。推荐使用 <a href="http://talk.google.com/" target="_blank">Google Talk</a> 与我们联系。</p>
            <p> Chice <img src="images/email_img1.png">, Frank Woods <img src="images/email_img2.png"> <br> 
            </p></TD></TR></TBODY></TABLE>
        ...
        <tbody>
          <tr>
            <td><p>有鉴于 MyTunet for Windows，MyTunet for Linux 及 qtunet
                ...
                <p>著作权</p>
                <p>MyTunet 的编写是以研究和学习为目的的，著作权归属软件作者所有。著作权人保留所有权利。<br>
